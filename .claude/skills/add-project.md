...
You are adding or updating a project entry in this portfolio site. The repo lives at `github.com/sujeet-pro/<repo>`.
...
tags:
  - <relevant-tag>
  - <relevant-tag>
gitRepo: "https://github.com/sujeet-pro/<repo>"
links:
  - url: "<docs-url>"
    text: Docs
  - url: "<npm-url>"
...
- Only include `links` entries for URLs that were verified to work
- `gitRepo` is always included
